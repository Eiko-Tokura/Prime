...
/* package Prime-0.1.0.0 */
#ifndef VERSION_Prime
#define VERSION_Prime "0.1.0.0"
#endif /* VERSION_Prime */
#ifndef MIN_VERSION_Prime
#define MIN_VERSION_Prime(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Prime */
...
#define CURRENT_COMPONENT_ID "Prime-0.1.0.0-inplace-Prime"
